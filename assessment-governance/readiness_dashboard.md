...
- Low-friction baseline diagnostic: `completed` on `2026-09-03`
  ([`ATT-20260903-01`](../assessments/attempts/2026-09-03-baseline-diagnostic.md),
  `20/40`, `50.0%`, `activation_needed`)
- Baseline form A: draft
- Pre-August form B: superseded without a learner attempt
...
Use this section once per week to record:

- modules moved to `pass`
- modules still at `review`
- modules requiring `activation_needed`
